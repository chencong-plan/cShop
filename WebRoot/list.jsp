...
<div class=site-nav>
    <div class=w>
        ...
        <ul class=nav-list>
            <li class=nav-item><a class=link href="user/cart.jsp"> <i class="fa fa-shopping-cart"></i> 购物车(<span
...
<div class=header>
    <div class=w><a class=logo href="index.jsp">ccoder</a>
        <div class=search-form><input class=search-input id="search-input" id="search-input" placeholder=请输入商品名称/>
