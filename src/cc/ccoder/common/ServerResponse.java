...
public class ServerResponse<T> implements Serializable {
	...
	/**
	 * 判断响应是否成功 和ResponseCode里面定义的响应编码进行对照 使用注解，使得在json序列化返回是不出现显示在json中
	 *
	...
	/**
	 * 创建一个成功的服务器响应 返回status 将ResponseCode的getCode作为ServerResponse的status返回
	...
	/**
	 * 创建一个成功的服务器响应 将ResponseCode的getCode作为ServerResponse的status，msg作为状态描述信息
	 * 创建成功返回一个msg文本供前端使用
	 *
	 * @param msg
	 *            描述信息
